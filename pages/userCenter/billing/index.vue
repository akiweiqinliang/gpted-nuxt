...
<div id="billingPage">
  ...
  <Card :padding="30" :dis-hover="true">
    <Table :disabled-hover="true" :row-class-name="rowClassName" :columns="columns" :data="showBillData" @on-cell-click="handleGoToDetailPage"></Table>
...
export default {
  ...
  methods: {
    ...
    handleGoToDetailPage(row, column, data, event) {
      // console.log(data,column)
      if (column.key !== 'orderNumber') return

      this.$router.push({ name: pageCode.USERCENTER_BILLING_ID, params: { id: data } })
    }
  }
}
</script>
